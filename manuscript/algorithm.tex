...
predict future demand of commodity markets.  These can be divided into three 
major branches, Non-optimizing, Deterministic Optimizing, and Stochastic 
Optimizing. Each vary in complexity, which leads to a difference in computing 
time and accuracy. The groups and examples of each are explained in detail 
below. 
