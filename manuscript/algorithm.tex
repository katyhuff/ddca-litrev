...
can handle the volatile dynamics of transitions between technolgies, upsets related to 
unexpected facility shutdowns, the variability of an increasingly renewable 
electric grid, and other nonlinearities of external economic drivers.
In these cases, the \gls{ARCH} model is more generically applicable and should 
therefore be preferred over the \gls{ARMA} model.
