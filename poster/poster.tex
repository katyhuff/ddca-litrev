...
\author{Kathryn D. Huff, Jin whan bae, Robert R. Flanagan, Anthony M. Scopatz} % Author(s)
...
\begin{figure}
	...
	\scalebox{0.8}{
		...
		\node [cloud, below of=of] (dem) {\texttt{DEMAND} \\ ex) Achieve 1\% growth for total electricity};
		\node [cloud, below of=dem] (con) {\texttt{CONSTRAINT} \\ex) Reprocessing available from 2025 };
